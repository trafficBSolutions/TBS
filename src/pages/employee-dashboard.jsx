        ...
        <div className="time-clock-section" style={{background:'#1a1a2e',padding:'1.5rem',borderRadius:'12px',marginBottom:'1.5rem',textAlign:'center'}}>
          ...
          {weekData && (
            <div style={{marginTop:'1rem',background:'#fff',borderRadius:'8px',padding:'1rem',textAlign:'left',color:'#333'}}>
              <button onClick={() => { setWeekData(null); setPin(''); setSelectedEmployee(null); setClockMsg(''); }} style={{marginBottom:'0.75rem',padding:'0.5rem 1.2rem',fontSize:'0.95rem',borderRadius:'8px',background:'#1a1a2e',color:'#fff',border:'none',cursor:'pointer'}}>← Back to Employees</button>
