...
const About = () => {
    return (
        <div className="page-3d">
            <GradientBackgroundCSS variant="dark" />
            <Header />
            <section className="section-3d" style={{paddingTop:'6rem'}}>
              <div className="section-3d-inner">
                <div className="glass-card" style={{padding:'3rem',maxWidth:'900px',margin:'0 auto'}}>
                    <h2 style={{fontSize:'2.5rem',color:'#e67e22',marginBottom:'1rem',textAlign:'center'}}>About Us</h2>
                    <p style={{fontSize:'1.2rem',color:'#ddd',lineHeight:1.7}}>
