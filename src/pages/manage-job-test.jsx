...
const fetchJob = async () => {
  try {
    ...
    const response = await axios.get(`https://tbs-server.onrender.com/traffic-control-test-page/${id}`);
    const fetchedJob = response.data;
    setJob(fetchedJob);
...
// Add a new function to actually save after confirmation
  const confirmSave = async () => {
    ...
    await axios.patch(`https://tbs-server.onrender.com/manage-job-test/${id}`, { updatedJob });
