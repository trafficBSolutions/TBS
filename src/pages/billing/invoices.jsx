...
const isExpanded = billingJob?._id === workOrder._id;
  ...
  <div style={{ marginTop: '15px', padding: '15px', border: '2px solid #007bff', borderRadius: '8px', backgroundColor: '#f8f9fa' }}>
    {/* 👉 paste the exact editor panel JSX you previously had inside Bill Job here */}
    {/* It will now show for both Bill Job and Update Invoice */}
    {/* Make sure the “Cancel” button sets setBillingOpen(false) and setBillingJob(null) */}
  </div>
)}
