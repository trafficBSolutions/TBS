...
function Header() {
    ...
    <img alt="TBS logo" className="tbs-logo-img" src="../public/tbs_companies/tbs.svg" />
    </a>
    ...
    <a className="header-worx-logo" href="">
        <img className="material-worx-img"alt="Material WorX logo" src="../public/tbs_companies/Material WorX.svg" />
