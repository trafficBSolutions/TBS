...
import { VITE_GOOGLE_MAPS_API_KEY } from '../constants/constantapi';
...
const businessAddress = "1995 Dews Pond Rd, Calhoun, GA 30701";
  ...
  const loadGoogleMapsScript = () => {
    if (!window.google || !window.google.maps) {
      ...
      script.src = `https://maps.googleapis.com/maps/api/js?key=${VITE_GOOGLE_MAPS_API_KEY}&libraries=geometry,places`;
      script.async = true;
      script.onload = () => {
