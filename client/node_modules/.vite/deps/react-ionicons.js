...
var require_lib = __commonJS({
  "node_modules/react-ionicons/lib/index.js"(exports, module) {
    ...
    var _index = (init_lib(), __toCommonJS(lib_exports));
    ...
    var Ionicon = function(_Component) {
      _inherits(Ionicon2, _Component);
      function Ionicon2(props) {
        _classCallCheck(this, Ionicon2);
        var _this = _possibleConstructorReturn(this, (Ionicon2.__proto__ || Object.getPrototypeOf(Ionicon2)).call(this, props));
        _this.state = { classNames: [], animationActive: false };
        _this._getClasses = _this._getClasses.bind(_this);
        return _this;
      }
      _createClass(Ionicon2, [{
        ...
        value: function _getPathByIconName() {
          ...
          try {
            for (var _iterator = _icons2.default[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if (icon.tags[0] == this.props.icon)
...
//# sourceMappingURL=react-ionicons.js.map
