...
<div className="sign-img-container">
    <img src="../road signs/GA State Route 53.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">State Route Sign</h3>
  </div>
  <div className="sign-img-container">
    <img src="../road signs/School Crossing.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">School Crossing Sign</h3>
  </div>
  <div className="sign-img-container">
    <img src="../road signs/speed Limit.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">Speed Limit Sign</h3>
  </div>
  </div>
  <div className="sign-group">
  <div className="sign-img-container">
    <img src="../road signs/U.S Route 41.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">U.S Route Sign</h3>
  </div>
  <div className="sign-img-container">
    <img src="../road signs/Utility Work Ahead.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">Utility Work Ahead Sign</h3>
  </div>
  <div className="sign-img-container">
    <img src="../road signs/Interstate 75.png" alt="sign" className="sign-img" />
  ...
  <div className="sign-group">
  <div className="sign-img-container">
    <img src="../road signs/Stop Sign.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">Stop Sign</h3>
  </div>
  <div className="sign-img-container">
    <img src="../road signs/Yield.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">Yield Sign</h3>
  </div>
  <div className="sign-img-container">
    <img src="../road signs/ped crossing.png" alt="sign" className="sign-img" />
    <h3 className="sign-img-text">Pedestrian Crossing Sign</h3>
  </div>
  </div>

  <div className="sign-img-container single-image">
    <img src="../road signs/Street Sign.png" alt="sign" className="sign-img" />
...
<div className="reflective-section">
        ...
        <img className="reflective-img" src="../road signs/reflective differences.png" alt="reflective differences" />
        </div>
...
<div className="post-img-section">
  <div className="post-img-container">
    <img src="../road signs/U Channel.png" alt="post" className="post-img" />
    <h3 className="post-img-text">U Channel Post</h3>
  </div>
  <div className="post2-img-container">
    <img src="../road signs/2x2 Square Post.png" alt="post" className="post-img" />
...
<div className="bracket-img-section">
  <div className="bracket-img-container">
    <img src="../road signs/5.5 Flat 180.jpg" alt="bracket" className="bracket-img" />
    <h3 className="bracket-img-text">5.5" Flat Blade for U Channel Post 180 Degree Cap with Hardware</h3>
  </div>
  <div className="bracket-img-container">
    <img src="../road signs/5.5 90 Bracket.jpg" alt="bracket" className="bracket-img" />
    <h3 className="bracket-img-text">5.5" Flat Blade for U Channel Post 90 Degree Cap with Hardware</h3>
  </div>
  <div className="bracket-img-container">
    <img src="../road signs/5.5 90 Cross Bracket.jpg" alt="bracket" className="bracket-img" />
    <h3 className="bracket-img-text">5.5" Flat Blade for U Channel post 90 Degree Cap Cross Piece for Two street signs</h3>
  </div>
  <div className="bracket-img-container">
    <img src="../road signs/12 Inch Flat Blade Cross.jpg" alt="bracket" className="bracket-img" />
    <h3 className="bracket-img-text">12" Flat Blade HD Bracket Cross Piece with 2 Tapped Holes</h3>
  </div>
  <div className="bracket-img-container">
    <img src="../road signs/12 Inch U Channel 180.jpg" alt="bracket" className="bracket-img" />
    <h3 className="bracket-img-text">12" for U Channel 180 Degree Cap</h3>
  </div>
  <div className="bracket-img-container">
    <img src="../road signs/12 Inch U Channel 90 Degree.jpg" alt="bracket" className="bracket-img" />
  ...
  {submissionErrorMessage &&
    ...
    <div className="site-footer__inner container container--narrow">
        <div className="footer-content">
          <img className="tbslogo" alt="TBS logo" src="../tbs_companies/TBS Logo1.png" />
        ...
        <div className="footer-contact">
            <div className="statement-box">
                ...
                <p className="trademark-warning">
                  <b className="warning-trade">WARNING:</b><b> Trademark Notice</b><img className="trademark-img" src="../tbs_companies/TBS Logo1.png"></img> is a registered trademark of Traffic & Barrier Solutions, LLC. 
